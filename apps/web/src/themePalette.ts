...
export const NORD_THEME_ID = "nord" as const;
export const NORD_THEME_LABEL = "Nord";
...
export const NORD_THEME: ThemeDefinition = {
  id: NORD_THEME_ID,
  label: NORD_THEME_LABEL,
  appearance: "dark",
  colors: {
    ...updateThemeColorFamily(
      "dark",
      createManagedThemeColors("dark", "#2e3440", "#88c0d0"),
      "messageAction",
      "#81a1c1",
    ),
    canvas: "#2e3440",
    chrome: "#2e3440",
    toolbar: "#2e3440",
    toolbarForeground: "#e5e9f0",
    surface: "#3b4252",
    surfaceRaised: "#434c5e",
    surfaceOverlay: "#3b4252",
    text: "#e5e9f0",
    textMuted: "#d8dee9",
    focus: "#88c0d0",
    accent: "#88c0d0",
    ...
    sidebarMutedForeground: "#d8dee9",
    sidebarControlSurface: "#434c5e",
    sidebarRowHover: "#434c5e",
    sidebarRowActive: "#4c566a",
    sidebarRowSelected: "#434c5e",
    sidebarBorder: "#4c566a",
    terminalBackground: "#2e3440",
    terminalForeground: "#e5e9f0",
    terminalCursor: "#88c0d0",
    terminalSelection: "#434c5e",
    terminalScrollbar: "#4c566a",
    terminalScrollbarHover: "#5e6a80",
  },
};

const BUILT_IN_THEME_DEFINITIONS: ReadonlyArray<ThemeDefinition> = [...BUILT_IN_THEMES, NORD_THEME];
